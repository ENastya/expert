...
import com.mycompany.expert_system_sb.RoleFacade;
...
public class RoleController implements Serializable {
    ...
    @EJB
    private com.mycompany.expert_system_sb.RoleFacade ejbFacade;
    ...
    public SelectItem[] getItemsAvailableSelectOne() {
        List<Role> roleList = ejbFacade.findAll();
        roleList.remove(0);
        /*for (Role r : roleList) {
        ...
        return JsfUtil.getSelectItems(roleList, true);
    }
